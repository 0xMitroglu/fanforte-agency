  ...
  return (
    <div className="privacy__policy">
      ...
      <p className="privacy__policy__p privacy__policy__p__first-child">
        At FanForte, accessible from www.fanforte-agency.vercel.app, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Fandafia and how we use it. <br />
        <br />
        ...
        shared and/or collect in Fandafia. This policy is not applicable to any
      ...
      <p className="privacy__policy__p">
        ...
        provide. We do not collect neither sell cookies.
      </p>
      ...
      <p className="privacy__policy__p">
        FanForte follows a standard procedure of using log files. These files
      ...
      <p className="privacy__policy__p">
        We do not use cookies, neither we use third-party ad servers or ad
        networks to personalize the website. We do not sell any data, or use
        Javascript or Web Beacons to get any personal information.
      </p>
      ...
      <p className="privacy__policy__p">
        As a consumer you have the right to: Request that a business that
        ...
        to exercise any of these rights, please contact us.(does not apply to us
        since we do not collect any type of data, but you can still contact us.)
      </p>
      ...
      <p className="privacy__policy__p">
        ...
        participate in, and/or monitor and guide their online activity. FanForte
        does not encourage neither supports the usage of OnlyFans for people
        under the age of 18. If you think that your child provided this kind of
